...
export default function DashboardSidebar() {
  return (
    <aside className="flex w-full shrink-0 flex-col border-b border-slate-800 bg-slate-950 lg:w-56 lg:border-b-0 lg:border-r">
      ...
      <DemoSidebarNav activeHref="/ai-dashboard" ariaLabel="AI dashboard" />

      <div className="mt-auto hidden border-t border-slate-800 p-4 lg:block">
        <p className="text-xs font-medium uppercase tracking-wider text-slate-500">
          System
        </p>
        <p className="mt-2 text-sm text-slate-300">All nodes operational</p>
        <p className="mt-1 h-4 text-xs text-emerald-400">● Live monitoring</p>
      </div>
    </aside>
  );
}
